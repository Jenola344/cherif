    ...
    return (
        <div className="min-h-screen bg-muted/30 flex items-center justify-center p-4">
            <div className="max-w-md w-full">
                ...
                <Suspense fallback={
                    <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl shadow-primary/5 border border-border/50 flex flex-col items-center justify-center animate-pulse min-h-[400px]">
